---
title: "Messaging"
description: "Drive Craft Agent sessions from Telegram, WhatsApp, or Lark/Feishu — send messages from any device and get agent replies back in the chat"
---
...
| **`final_only`** | Silent until the run completes, then one message with the final text. If no non-intermediate final arrived, the most recent assistant text is posted instead; genuinely empty runs stay silent. | Quiet chats, batch-style workflows. |
