  ...
  items: [
    {
      ...
      ipcChannel: IPC_CHANNELS.menu.UNDO,
    },
    {
      type: 'role',
      role: 'redo',
      ...
      ipcChannel: IPC_CHANNELS.menu.REDO,
    },
    { type: 'separator' },
    {
      type: 'role',
      ...
      ipcChannel: IPC_CHANNELS.menu.CUT,
    },
    {
      type: 'role',
      role: 'copy',
      ...
      ipcChannel: IPC_CHANNELS.menu.COPY,
    },
    {
      type: 'role',
      role: 'paste',
      ...
      ipcChannel: IPC_CHANNELS.menu.PASTE,
    },
    { type: 'separator' },
    {
      type: 'role',
      ...
      ipcChannel: IPC_CHANNELS.menu.SELECT_ALL,
    },
  ],
}
  ...
  items: [
    {
      ...
      ipcChannel: IPC_CHANNELS.menu.ZOOM_IN,
    },
    {
      type: 'role',
      role: 'zoomOut',
      ...
      shortcutDisplayMac: '⌘-',
      shortcutDisplayOther: 'Ctrl+-',
      ipcChannel: IPC_CHANNELS.menu.ZOOM_OUT,
    },
    {
      type: 'role',
      role: 'resetZoom',
      ...
      ipcChannel: IPC_CHANNELS.menu.ZOOM_RESET,
    },
    { type: 'separator' },
    {
      type: 'action',
      ...
      shortcutDisplayMac: '⌘.',
      shortcutDisplayOther: 'Ctrl+.',
      ipcChannel: IPC_CHANNELS.menu.TOGGLE_FOCUS_MODE,
      icon: 'Focus',
    },
    {
      type: 'action',
      ...
      ipcChannel: IPC_CHANNELS.menu.TOGGLE_SIDEBAR,
      icon: 'PanelLeft',
    },
  ],
}
  ...
  items: [
    {
      ...
      ipcChannel: IPC_CHANNELS.menu.MINIMIZE,
    },
    {
      type: 'role',
      role: 'zoom',
      label: 'Maximize',
      icon: 'Maximize2',
      ipcChannel: IPC_CHANNELS.menu.MAXIMIZE,
    },
  ],
}
