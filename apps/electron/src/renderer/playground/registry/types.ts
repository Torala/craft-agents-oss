...
export type Category = 'Sources' | 'Automations' | 'Onboarding' | 'Agent Setup' | 'Chat' | 'Session List' | 'Entity Lists' | 'Planner' | 'Edit Popover' | 'Turn Cards' | 'TurnCard Modes' | 'Fullscreen' | 'Chat Messages' | 'Chat Inputs' | 'Toast Messages' | 'Markdown' | 'Icons' | 'Settings' | 'Feedback' | 'OAuth'
