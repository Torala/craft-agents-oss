...
function LoadingBubble() {
  return (
    <div className="h-16 w-16 rounded-[8px] bg-white shadow-minimal flex items-center justify-center shrink-0">
  ...
  return (
    <div className="relative group shrink-0">
      ...
      {isImage ? (
        ...
        <div className="h-16 w-16 rounded-[8px] overflow-hidden bg-white shadow-minimal">
          {imageSrc ? (
        ...
        <div className="h-16 flex items-center gap-2.5 rounded-[8px] bg-foreground/5 pl-1.5 pr-3">
          {/* A4-like preview */}
          <div className="h-12 w-9 rounded-[6px] overflow-hidden bg-white shadow-minimal flex items-center justify-center shrink-0">
            {hasThumbnail ? (
              <img
