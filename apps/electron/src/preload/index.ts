...
const api: ElectronAPI = {
  ...
  // Event listeners
  onSessionEvent: listen(IPC_CHANNELS.sessions.EVENT),
  onUnreadSummaryChanged: listen(IPC_CHANNELS.sessions.UNREAD_SUMMARY_CHANGED),
  ...
  onSystemThemeChange: listen(IPC_CHANNELS.theme.SYSTEM_CHANGED),
  ...
  onUpdateAvailable: listen(IPC_CHANNELS.update.AVAILABLE),
  onUpdateDownloadProgress: listen(IPC_CHANNELS.update.DOWNLOAD_PROGRESS),
  ...
  onDeepLinkNavigate: listen(IPC_CHANNELS.deeplink.NAVIGATE),
  ...
  onCopilotDeviceCode: listen(IPC_CHANNELS.copilot.DEVICE_CODE),
  ...
  debugLog: send(IPC_CHANNELS.debug.LOG),
  ...
  onSessionFilesChanged: listen(IPC_CHANNELS.sessions.FILES_CHANGED),
  ...
  onSourcesChanged: listen(IPC_CHANNELS.sources.CHANGED),
  ...
  onSkillsChanged: listen(IPC_CHANNELS.skills.CHANGED),

  // Statuses change listener
  onStatusesChanged: listen(IPC_CHANNELS.statuses.CHANGED),
  ...
  onLabelsChanged: listen(IPC_CHANNELS.labels.CHANGED),
  ...
  onAppThemeChange: listen(IPC_CHANNELS.theme.APP_CHANGED),
  broadcastThemePreferences: invoke(IPC_CHANNELS.theme.BROADCAST_PREFERENCES),
  onThemePreferencesChange: listen(IPC_CHANNELS.theme.PREFERENCES_CHANGED),
  broadcastWorkspaceThemeChange: invoke(IPC_CHANNELS.theme.BROADCAST_WORKSPACE_THEME),
  onWorkspaceThemeChange: listen(IPC_CHANNELS.theme.WORKSPACE_THEME_CHANGED),
  ...
  onBadgeDraw: listen(IPC_CHANNELS.badge.DRAW),
  onBadgeDrawWindows: listen(IPC_CHANNELS.badge.DRAW_WINDOWS),

  // Window focus
  getWindowFocusState: invoke(IPC_CHANNELS.window.GET_FOCUS_STATE),
  onWindowFocusChange: listen(IPC_CHANNELS.window.FOCUS_STATE),
  onNotificationNavigate: listen(IPC_CHANNELS.notification.NAVIGATE),
  ...
  browserPane: {
    create: invoke(IPC_CHANNELS.browserPane.CREATE),
    destroy: invoke(IPC_CHANNELS.browserPane.DESTROY),
    list: invoke(IPC_CHANNELS.browserPane.LIST),
    navigate: invoke(IPC_CHANNELS.browserPane.NAVIGATE),
    goBack: invoke(IPC_CHANNELS.browserPane.GO_BACK),
    goForward: invoke(IPC_CHANNELS.browserPane.GO_FORWARD),
    reload: invoke(IPC_CHANNELS.browserPane.RELOAD),
    stop: invoke(IPC_CHANNELS.browserPane.STOP),
    focus: invoke(IPC_CHANNELS.browserPane.FOCUS),
    emptyStateLaunch: invoke(IPC_CHANNELS.browserPane.LAUNCH),
    onStateChanged: listen(IPC_CHANNELS.browserPane.STATE_CHANGED),
    onRemoved: listen(IPC_CHANNELS.browserPane.REMOVED),
    onInteracted: listen(IPC_CHANNELS.browserPane.INTERACTED),
  },
  ...
  onAutomationsChanged: listen(IPC_CHANNELS.automations.CHANGED),
}
