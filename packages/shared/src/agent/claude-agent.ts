...
import { buildSdkHooks, type SdkHookCallbackMatcher } from '../hooks-simple/index.ts';
  ...
  async *chat(
    ...
    try {
      ...
      const options: Options = {
        ...
        hooks: (() => {
          // Build user-defined hooks from hooks.json for SDK events
          const userHooks = buildSdkHooks();
