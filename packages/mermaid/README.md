...
[Live Demo](https://lukilabs.github.io/beautiful-mermaid) · [Themes](#themes) · [API](#api)
...
- **Dated aesthetics** — The visual output feels like 2015
...
Built with care by the [Craft](https://craft.do) team to power [Craft Agents](https://agents.craft.do)
